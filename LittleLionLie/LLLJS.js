...
function changeImage2(){
		...
		if(ant2 == 4){
			ant2 = 0;
			document.getElementById('artshowcase2').src="Bild3-13.jpg";
		}
		else if(ant2 == 1){
			document.getElementById('artshowcase2').src="Bild4-18.jpg";
			}
		else if(ant2 == 2){
			document.getElementById('artshowcase2').src="Bild4-21.jpg";
			}
		else if(ant2 == 3){
			document.getElementById('artshowcase2').src="Bild4-1.jpg";
			}
		}
